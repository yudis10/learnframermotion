      ...
      >
        <div className="sticky top-0 flex h-screen items-center">
          <div className="relative left-1/2 mb-5 flex -translate-x-1/2 gap-5">
            ...
            <motion.div
              style={{ scale }}
              className="relative z-10 aspect-[9/16] w-[300px] shrink-0 overflow-clip rounded-2xl md:aspect-video md:w-[60vw]"
            >
              <img
                className="h-full w-full object-cover"
                src={movies[1].poster}
              ...
              <motion.div
                ...
                className="absolute bottom-0 left-0 flex w-full flex-col items-center justify-between gap-4 p-5 text-lg text-white md:flex-row md:gap-0"
              >
